...
if (ds_list_find_index(global.saveroom, id) != -1)
	visited = true;
if (visited == 1 && sprite_index != spr_noisedoor && sprite_index != spr_noisedoor && sprite_index != spr_noisedoor && sprite_index != spr_noisedoor && sprite_index != spr_noisedoor && sprite_index != spr_noisedoor)
	sprite_index = spr_noisedoor;
if (sprite_index == spr_noisedoor || sprite_index == spr_noisedoor)
{
