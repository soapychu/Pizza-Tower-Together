...
// visibility
visible = true;
if room == strongcold_endscreen or room == funnyintro or room == Longintro or room == Mainmenu or room == rm_levelselect or room == rank_room or room == timesuproom or room == Realtitlescreen or room == characterselect or room == basement_entrance or room == basement_1 or room == basement_2 or room == hub_loadingscreen or (string_copy(room_get_name(room), 1, 5) == "tower" && !global.panic)
	visible = false;
