...
if (place_meeting(x, y, obj_player) && sprite_index == spr_boxunopen)
{
	global.combotime = 60;
	...
	if (content == obj_pizzakinshroom)
	{
		...
		if check_sugary()
		tv_do_expression(spr_tv_confecti1)
	...
	if (content == obj_pizzakincheese)
	{
		...
		if check_sugary()
		tv_do_expression(spr_tv_confecti2)
		instance_create(x, y, obj_taunteffect);
		if (global.toppintotal < 5)
			obj_tv.message = "YOU NEED " + string(5 - global.toppintotal) + " MORE TOPPINS!";
		if (global.toppintotal == 5)
	...
	if (content == obj_pizzakintomato)
	{
		...
		instance_create(x, y, obj_taunteffect);
		if check_sugary()
		tv_do_expression(spr_tv_confecti3)
		if (global.toppintotal < 5)
			obj_tv.message = "YOU NEED " + string(5 - global.toppintotal) + " MORE TOPPINS!";
		if (global.toppintotal == 5)
			obj_tv.message = "YOU HAVE ALL TOPPINS!";
	...
	if (content == obj_pizzakinsausage)
	{
		...
		if check_sugary()
		tv_do_expression(spr_tv_confecti4)
		instance_create(x, y, obj_taunteffect);
		if (global.toppintotal < 5)
			obj_tv.message = "YOU NEED " + string(5 - global.toppintotal) + " MORE TOPPINS!";
		if (global.toppintotal == 5)
	...
	if (content == obj_pizzakinpineapple)
	{
		...
		instance_create(x, y, obj_taunteffect);
				if check_sugary()
		tv_do_expression(spr_tv_confecti5)
		global.heattime = 60;
		global.style += 10;
